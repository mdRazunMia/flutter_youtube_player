...
import 'package:video_player_flutter/screens/video_screen.dart';
import 'package:video_player_flutter/services/api_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
 ...
 _loadMoreVideos() async{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('YouTube Channel Videos'),
      ),
      body: _channel != null 
